...
> **For Claude:**
> MANDATORY SUB-SKILL: You SHALL use wezzard:execute-plan to execut this plan.
> MANDATORY SUB-SKILL: You SHALL use wezzard:review to review the result after the plan was executed.
